...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($quiz_title) || empty($quiz_description) || empty($difficulty) || empty($classroom_id)) {
    ...
    $stmt = $conn->prepare("INSERT INTO quiz (user_id, classroom_id, quiz_title, quiz_description, difficulty, created_at) VALUES (?, ?, ?, ?, ?, NOW())");
    $stmt->bind_param("iisss", $user_id, $classroom_id, $quiz_title, $quiz_description, $difficulty);
