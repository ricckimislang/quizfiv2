!(function (a) {
  (a.jGrowl = function (b, c) {
    0 === a("#jGrowl").length &&
      a('<div id="jGrowl"></div>')
        .addClass(c && c.position ? c.position : a.jGrowl.defaults.position)
        .appendTo(c && c.appendTo ? c.appendTo : a.jGrowl.defaults.appendTo),
      a("#jGrowl").jGrowl(b, c);
  }),
    (a.fn.jGrowl = function (b, c) {
      if (
        (void 0 === c && a.isPlainObject(b) && ((c = b), (b = c.message)),
        ...
        return this.each(function () {
          void 0 === a(this).data("jGrowl.instance") &&
            ...
            a.isFunction(a(this).data("jGrowl.instance")[b])
              ? a(this)
                  .data("jGrowl.instance")
                  [b].apply(
                    a(this).data("jGrowl.instance"),
                    a.makeArray(d).slice(1)
                  )
              : a(this).data("jGrowl.instance").create(b, c);
        });
      }
    }),
    a.extend(a.fn.jGrowl.prototype, {
      ...
      create: function (b, c) {
        ...
        "undefined" != typeof d.speed &&
          ((d.openDuration = d.speed), (d.closeDuration = d.speed)),
          this.notifications.push({ message: b, options: d }),
        ...
        var f = a("<div/>")
          .addClass(
            "jGrowl-notification alert " +
              e.themeState +
              " ui-corner-all" +
              (void 0 !== e.group && "" !== e.group ? " " + e.group : "")
          )
          .append(a("<button/>").addClass("jGrowl-close").html(e.closeTemplate))
        ...
        a(f)
          ...
          .bind("jGrowl.open", function () {
            e.open.apply(f, [f, d, e, c.element]) !== !1 &&
              ("after" == e.glue
                ? a(".jGrowl-notification:last", c.element).after(f)
                : a(".jGrowl-notification:first", c.element).before(f),
              a(this).animate(
                e.animateOpen,
                e.openDuration,
                e.easing,
                function () {
                  a.support.opacity === !1 &&
                    ...
                    null !== a(this).data("jGrowl") &&
                      "undefined" != typeof a(this).data("jGrowl") &&
              ...
              a(this).animate(
                ...
                function () {
                  a.isFunction(e.close)
                    ? e.close.apply(f, [f, d, e, c.element]) !== !1 &&
                      a(this).remove()
                    : a(this).remove();
                }
              );
          ...
          a(".jGrowl-notification:parent", c.element).length > 1 &&
            0 === a(".jGrowl-closer", c.element).length &&
            ...
            a(this.defaults.closerTemplate)
              ...
              .bind("click.jGrowl", function () {
                a(this).siblings().trigger("jGrowl.beforeClose"),
                  a.isFunction(c.defaults.closer) &&
                    c.defaults.closer.apply(a(this).parent()[0], [
                      a(this).parent()[0],
                    ]);
              });
      },
