    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 400px;">
        <div class="modal-content" style="border-radius: 10px;">
            ...
            <div class="modal-footer" style="border-top: none; padding: 0px 20px 20px 20px;">
                <button type="button" class="passbtn btn primary-btn" onclick="changePassword()">
                    Change Password Now
                </button>
                <button type="button" class="passbtn btn btn-secondary" data-bs-dismiss="modal">Later</button>
            </div>
        </div>
    </div>
</div>
