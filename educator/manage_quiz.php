                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="classroom_id" name="classroom_id">
                                ...
                                if (isset($_SESSION['user_id'])) {
                                    ...
                                    $query = "SELECT classroom_name, classroom_id FROM classroom WHERE user_id = '$user_id'";
                                    $result = $conn->query($query);

                                    if ($result && $result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            echo '<option value="' . htmlspecialchars($row['classroom_id']) . '">'
                                                . htmlspecialchars($row['classroom_name']) . '</option>';
                                        }
                                    } else {
                                        echo '<option value="" disabled>No classrooms found</option>';
                                    }
                                } else {
                                    echo '<option value="" disabled>Please login first</option>';
                                }
                                ?>
                            </select>
        ...
        <script>
            $(document).ready(function() {
                ...
                function validateForm() {
                    ...
                    if (!$("#classroom_id").val()) {
                        isValid = false;
                        showWarning("#classroom_id", "Please select a classroom.");
                    }
